...
#define LS_IOCTL_BASE         'L'
#define CMD_LI_READ				_IOW(LS_IOCTL_BASE, 0, int)
...
//---------------------------------------------------
// T, CL, or FN Package coefficients
//---------------------------------------------------
...
#define TSL256X_POWER_DOWN		0x00
#define TSL256X_POWER_UP		0x03
#define TSL256X_STANDARD_RANGE          0x18
#define TSL256X_EXTENDED_RANGE          0x1d
#define TSL256X_READ_ADC0               0x43
#define TSL256X_READ_ADC1               0x83
